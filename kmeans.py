...
ks = [1,2,3,4,5,8,13,20,50,100,200,500]
#ks = [1,3,5,10,50,200,1000] # for performance measurement
...
for k in ks:
    ...
    WSSSE = 0
    # for performance measurement omit error estimation (very time consuming step)
    WSSSE = parsedData.map(lambda point: error(point)).reduce(lambda x, y: x + y)

    output = "k={}, error={}, duration={} seconds, epsilon={}".format(k, WSSSE, elapsed, epsilon)

    with open("/home/binderchri/kddcup1999/out.txt", "a") as f:
        print(output, file=f)
